...
const featureDescriptions: Record<string, Record<string, string>> = {
  ...
  feedbacklens: {
    ...
    "Duplicate detection": "Link repeated complaints across pasted notes, CSV imports, forwarded messages, and support notes.",
    ...
    "Manual and source ingestion": "Collect feedback from manual notes, CSV imports, forwarded messages, and API imports in one inbox.",
  ...
  invoicefollow: {
    ...
    "Usage quota": "Keep invoice, email, NLP, and retention limits visible as the workflow grows.",
  },
};
