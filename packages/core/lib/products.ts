...
const sharedPlans = (product: string, beta = false): ProductPlan[] => [
  ...
  },
  {
    ...
    name: "Pro",
    price: 9.99,
    priceLabel: beta ? "$9.99 beta" : "$9.99",
...
export const DEVFORGE_PRODUCTS: DevForgeProduct[] = [
  ...
  },
  {
    ...
    description: "InvoiceFollow tracks existing invoices, sends reminder sequences, classifies replies, and reconciles payment events.",
