    ...
    <div className="min-h-screen bg-black text-white p-6 md:p-24 max-w-3xl mx-auto selection:bg-accent selection:text-black">
      ...
      <div className="space-y-6 text-neutral-400">
        ...
        <div>
          ...
          <p>To ensure user satisfaction, FileCleaner offers a 7-day free trial. During this time, you have full access to our platform's enterprise-grade infrastructure features, allowing you to evaluate if it meets your needs.</p>
