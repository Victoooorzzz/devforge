    ...
    <div className="min-h-screen bg-black text-white p-10 md:p-24 selection:bg-accent selection:text-black">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4 text-neutral-300">
          ...
          <p>Al utilizar FileCleaner, usted acepta estos términos. Proveemos esta herramienta "tal cual", sin garantías de ningún tipo. Usted es responsable del uso que le dé a la plataforma.</p>
