export const product = {
  ...
  hero: {
    ...
    subtitle: "Track existing invoices from email, CSV, PDF workflows, or a safe tracking form. InvoiceFollow handles reminders, reply classification, and payment reconciliation.",
    ctaText: "Start Free",
    ctaHref: "/register",
  ...
  features: [
    ...
    { title: "Payment Matching", description: "Detect Stripe and PayPal payments by invoice metadata, amount, date, and client." },
  ...
  pricing: {
    ...
    features: [
      ...
      { text: "Stripe read-only payment matching", included: true },
      { text: "Custom templates and weekly digest", included: true },
      { text: "Team users and PayPal matching", included: false },
    ],
  },
  testimonials: [
