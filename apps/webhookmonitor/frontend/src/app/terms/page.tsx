  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 md:p-24 max-w-3xl mx-auto selection:bg-accent selection:text-black">
      ...
      <div className="space-y-6 text-neutral-400">
        ...
        <p>By using WebhookMonitor, you agree to these terms. We provide this tool "as is", without any warranties. You are responsible for your use of the platform.</p>
